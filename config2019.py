...
trn_eval_set_name = 'asvspoof2019_trn_eval'
val_eval_set_name = 'asvspoof2019_val_eval'
...
trn_list = tmp + '/ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.train.trn.txt'
# val_file_list: list of files for validation set. It can be None
val_list = tmp + '/ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.dev.trl.txt'
...
input_dirs = [tmp + '/ASVspoof2019_LA_train/flac', './asvspoof2019_eval_part/train']
val_input_dirs = [tmp + '/ASVspoof2019_LA_dev/flac', './asvspoof2019_eval_part/eval']
proto_train_dir = tmp + '/ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.train_eval.trn.txt'
proto_dev_dir = tmp + '/ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.dev_eval.trl.txt'
proto_eval_dir = tmp + '/ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.eval.trl.txt'
...
test_set_name = 'FMFCC-A_test'
test_eval_set_name = 'FMFCC-A'

# List of test set data
# for convenience, you may directly load test_set list here
test_list = './FMFCC-DATASET/test_proto.txt'

# Directories for input features
# input_dirs = [path_of_feature_1, path_of_feature_2, ..., ]
#  we assume train and validation data are put in the same sub-directory
test_input_dirs = ['./FMFCC-DATASET/test-set']

# Directories for output features, which are []
test_input_exts = ['.wav']
test_input_norm = [False]
test_input_dims = [1]
test_input_reso = [1]
test_output_dirs = []
