...
class NIIDataSetLoader:
    ...
    def __init__(self, setname,
        ...
        for info in seq_info_buff:
            file_name = os.path.basename(info.seq_name).split('.')[0]
    ...
    def protocol_parse(self, protocol_filepath):
        ...
        for row in temp_buffer:
            if row[-1] == 'bonafide':
                ...
                data_buffer[row[1]] = 10
            elif row[-2] == 'A11':
                data_buffer[row[1]] = 11
            elif row[-2] == 'A12':
                data_buffer[row[1]] = 12
            elif row[-2] == 'A13':
                data_buffer[row[1]] = 13
            elif row[-2] == 'A14':
                data_buffer[row[1]] = 14
            elif row[-2] == 'A15':
                data_buffer[row[1]] = 15
            elif row[-2] == 'A16':
                data_buffer[row[1]] = 4
            elif row[-2] == 'A17':
                data_buffer[row[1]] = 16
            elif row[-2] == 'A18':
                data_buffer[row[1]] = 17
            elif row[-2] == 'A19':
                data_buffer[row[1]] = 6
        return data_buffer
